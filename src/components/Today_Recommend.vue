<template lang="html">
  <div class="mod-albums">
      <div class="hd log url">
          <h2>今日推荐</h2>
          <router-link tag="div" :to="{name:'MoreList',params:{currenttype:'今日推荐',musictype:'24'}}">更多</router-link>
      </div>
      <div class="container">
          <div class="gallery">
              <div class="scroller">
...
export default {
  ...
  created(){
    const newsMusicUrl = this.HOST + "/v1/restserver/ting?method=baidu.ting.billboard.billList&type=24&size=6&offset=0";
