<template lang="html">
  <div class="mod-albums">
      <div class="hd log url">
          <h2>新歌速递</h2>
          <router-link tag="div" :to="{name:'MoreList',params:{currenttype:'新歌速递',musictype:'1'}}">更多</router-link>
      </div>
      <div class="container">
          <div class="gallery">
              <div class="scroller">
...
export default {
  ...
  created(){
    // 新歌速递URL
    const newsMusicUrl = this.HOST + "/v1/restserver/ting?method=baidu.ting.billboard.billList&type=1&size=3&offset=0";
